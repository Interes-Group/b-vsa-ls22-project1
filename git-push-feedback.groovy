...
String REPO_URL = "https://github.com/Interes-Group/semestralny-projekt-1-skupina-"
Boolean ALL = true
...
def pushFolder = { File project ->
    ...
    String group = project.parentFile.name.replace("skupina", "").toLowerCase()
    String repo = REPO_URL + group + '-' + project.name
